#define NGX_CONFIGURE " --prefix=/usr/local/my-nginx --add-module=/home/keweilu/QAT/nginx-1.24.0/src/modules/myHandler --with-debug"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/my-nginx/"
#endif
